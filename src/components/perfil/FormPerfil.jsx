...
function FormPerfil({ user, hanleChange, change, usuario, credenciales }) {
    ...
    return (
        <>
            ...
            <div className="max-w-full flex flex-col sm:flex-row sm:space-x-4 sm:mt-3">
                {(credenciales.Rol != 0 && credenciales.Rol != 1) ?
                    <>
                        ...
                        <div className="w-full sm:w-1/2">
                            ...
                            <TextInput disabled id="documento" type="text" icon={FaIdCard}
                    ...
                    <div className="w-full">
                        ...
                        <TextInput disabled id="documento" type="text" icon={FaIdCard}
                            value={credenciales.Documento} name='Documento' placeholder="Digite el numero de documento..." required />
                    </div>
                }
                <div className="w-full">
                    <div className="mb-2 block">
