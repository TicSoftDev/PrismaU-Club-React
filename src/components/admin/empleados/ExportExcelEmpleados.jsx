...
const ExportExcelEmpleados = ({ data, fileName }) => {
    ...
    return (
        <button className='inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-orange-500 border border-orange-500 hover:bg-white hover:text-orange-500 focus:z-10 focus:ring-2 rounded-e-lg' onClick={exportToCSV}>
