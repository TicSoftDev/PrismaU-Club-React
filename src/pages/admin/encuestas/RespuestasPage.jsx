...
function RespuestasPage() {
  ...
  const { titulo, tituloModal, lista, openModal, loading, respuesta,
    handleChange, handleSubmit, toggleModal, cargarRespuesta, handleUpdate, handleDelete, } = useRespuestasEncuesta(entidad.id);
  ...
  return (
    <>
      ...
      <Container>
        ...
        <CardPreguntaRespuesta texto={entidad.Pregunta} />
        <DataTablePreguntasRespuestas data={lista} loading={loading} editar={cargarRespuesta} eliminar={handleDelete}
          rol={rol} name={'Respuesta'} respuesta={true} />
