...
export default function CardsUbicaciones({ loading, ubicaciones, ubicacion, selectLocation }) {
    ...
    return (
        <div className="w-full">
            <div className="mb-2">
                <h3 className="text-lg font-bold text-gray-800">Selecciona una ubicación</h3>
            </div>
