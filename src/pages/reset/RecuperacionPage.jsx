...
function RecuperacionPage() {
  ...
  const { documento, loading,
    handleChangeDocumento, enviarCodigo } = useReset();
  ...
  return (
    <ContainerReset>
      <div className='md:w-1/2 px-8 pt-8 flex flex-col w-full'>
        ...
        <h1 className='text-4xl mb-5 sm:mb-10'>Busca tu cuenta</h1>
        <p className='text-lg'>Ingresa tu número de identificación para recuperar tu cuenta</p>
      </div>
      <div className='md:w-1/2 px-8 pt-8 flex flex-col items-end justify-end w-full'>
        <div className="relative w-full my-auto">
          <input type="text" id="documento" className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" "
            onChange={handleChangeDocumento} value={documento} />
        ...
        <div className="flex flex-row my-5">
          ...
          <button type='button' onClick={enviarCodigo} className="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-4 sm:px-5 py-2 sm:py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
